...
def main():
    ...
    with st.container():
        ...
        <div style="background-color: #000080; padding: 20px; border-radius: 10px; border-left: 5px solid #1f77b4; margin-bottom: 20px;">
            ...
            <p><strong>Key features demonstrated:</strong> Issue similarity matching, tech stack intelligence, community analytics, and strategic business planning.</p>
            <p><strong>Created by:</strong> Reverie | <strong>GitHub:</strong> <a href="https://github.com/rexieboy18/tidb-community-intelligence" target="_blank">View Source Code</a></p>
        </div>
